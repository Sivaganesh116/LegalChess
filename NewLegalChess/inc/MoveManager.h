...
class MoveManager {
public:
    virtual CheckType handleMove(int fromRow, int fromCol, int toRow, int toCol, int fromSquare, int toSquare, bool isPieceWhite, Board& board) = 0;
};

class PawnMoveManager : public MoveManager {
public:
    CheckType handleMove(int fromRow, int fromCol, int toRow, int toCol, int fromSquare, int toSquare, bool isPieceWhite, Board& board) override;
    CheckType handlePromotion(char newPiece, int fromRow, int fromCol, int toRow, int toCol, bool isPieceWhite, Board& board);
};
